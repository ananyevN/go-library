...
func (_m *BookUseCase) Add(ctx context.Context, book *domain.Book) error {
...
func (_m *BookUseCase) Delete(ctx context.Context, id int) error {
...
func (_m *BookUseCase) Fetch(ctx context.Context, num int, offset int) ([]domain.Book, error) {
...
func (_m *BookUseCase) Update(ctx context.Context, book *domain.Book) error {
	ret := _m.Called(ctx, book)
